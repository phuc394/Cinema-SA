...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateOrder = channel.unary_unary(
                '/cinema.order.v1.OrderService/CreateOrder',
        ...
        self.GetOrder = channel.unary_unary(
                '/cinema.order.v1.OrderService/GetOrder',
                request_serializer=order__pb2.GetOrderRequest.SerializeToString,
                response_deserializer=order__pb2.OrderResponse.FromString,
                _registered_method=True)
        self.ListOrdersByUser = channel.unary_unary(
                '/cinema.order.v1.OrderService/ListOrdersByUser',
                request_serializer=order__pb2.ListOrdersByUserRequest.SerializeToString,
                response_deserializer=order__pb2.ListOrdersByUserResponse.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListOrdersByUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__pb2.ListOrdersByUserRequest.FromString,
                    response_serializer=order__pb2.ListOrdersByUserResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cinema.order.v1.OrderService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cinema.order.v1.OrderService', rpc_method_handlers)
...
class OrderService(object):
    ...
    def ListOrdersByUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cinema.order.v1.OrderService/ListOrdersByUser',
            order__pb2.ListOrdersByUserRequest.SerializeToString,
            order__pb2.ListOrdersByUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
