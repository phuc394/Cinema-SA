...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Register = channel.unary_unary(
                '/cinema.auth.v1.AuthService/Register',
                request_serializer=auth__pb2.RegisterRequest.SerializeToString,
                response_deserializer=auth__pb2.AuthUserResponse.FromString,
                _registered_method=True)
        self.Login = channel.unary_unary(
                '/cinema.auth.v1.AuthService/Login',
        ...
        self.ValidateToken = channel.unary_unary(
                '/cinema.auth.v1.AuthService/ValidateToken',
        ...
        self.GetUser = channel.unary_unary(
                '/cinema.auth.v1.AuthService/GetUser',
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Register': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=auth__pb2.AuthUserResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cinema.auth.v1.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cinema.auth.v1.AuthService', rpc_method_handlers)
...
class AuthService(object):
    ...
    def Register(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            auth__pb2.AuthUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
